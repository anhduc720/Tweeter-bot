...
$config['platform']             = 'Tweendo';
$config['platform_version']     = 'v1.0.0';
$config['consumer_key']         = CONSUMER_KEY;
$config['consumer_key_secret']  = CONSUMER_KEY_SECRET;
$config['oauth_callback']       = OAUTH_CALLBACK;
$config['platform_description'] = 'Schedule your texts, images and videos for Twitter';
...
$config['csrf_cookie_name'] = 'tweendo_csrf';
