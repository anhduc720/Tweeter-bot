...
//CUSTOM TWITTEROAUTH PHP CLASS FOR WORKING WHIT CODEIGNITER FRAMEWORK
/**
...
class Twitteroauth extends Config
{
    ...
    public function __construct($params)
        ...
        $consumerKey      = isset($params['consumer_key']) ? $params['consumer_key'] : null;
        $consumerSecret   = isset($params['consumer_key_secret']) ? $params['consumer_key_secret'] : null;
        $oauthToken       = isset($params['oauth_token']) ? $params['oauth_token'] : null;
        $oauthTokenSecret = isset($params['oauth_token_secret']) ? $params['oauth_token_secret'] : null;
